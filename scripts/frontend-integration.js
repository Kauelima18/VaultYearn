 ...
 * This file demonstrates how to integrate Vaultyearnearn with a web frontend
 */

// For React/Vue/Angular applications
export class VaultyearnearnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VaultyearnearnClient(provider, contractAddress);
